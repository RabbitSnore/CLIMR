...
```
    ...
    ##    item          d    ci_lb  ci_ub
    ##    <chr>     <dbl>    <dbl>  <dbl>
    ##  1 bif_02  0.0450  -0.0270  0.117 
    ##  2 bif_04 -0.00414 -0.0761  0.0678
...
```
    ...
    ## 
    ##             estim    sqrt  nlvls  fixed        factor 
    ## sigma^2    0.0107  0.1036     79     no  lab_modality 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 1005) = 1033.1348, p-val = 0.2622
    ## 
    ## Test of Moderators (coefficients 1:13):
    ## QM(df = 13) = 9.2981, p-val = 0.7501
    ## 
    ## Model Results:
    ## 
    ##             estimate      se     zval    pval    ci.lb   ci.ub    
    ## itembif_02    0.0471  0.0391   1.2066  0.2276  -0.0294  0.1237    
    ## itembif_04    0.0041  0.0390   0.1047  0.9166  -0.0723  0.0804    
    ## itembif_05    0.0676  0.0390   1.7342  0.0829  -0.0088  0.1440  . 
    ## itembif_07    0.0044  0.0390   0.1132  0.9099  -0.0720  0.0808    
    ## itembif_09    0.0047  0.0390   0.1199  0.9046  -0.0718  0.0811    
    ## itembif_10    0.0656  0.0392   1.6711  0.0947  -0.0113  0.1425  . 
    ## itembif_12   -0.0079  0.0394  -0.2003  0.8412  -0.0851  0.0694    
    ## itembif_14    0.0515  0.0389   1.3238  0.1856  -0.0248  0.1278    
    ## itembif_16   -0.0271  0.0390  -0.6942  0.4876  -0.1036  0.0494    
    ## itembif_19    0.0149  0.0391   0.3812  0.7031  -0.0617  0.0915    
    ## itembif_20    0.0090  0.0395   0.2275  0.8201  -0.0684  0.0864    
    ## itembif_22    0.0022  0.0391   0.0563  0.9551  -0.0745  0.0789    
    ## itembif_23    0.0346  0.0390   0.8878  0.3747  -0.0418  0.1110    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
