...
In the original study, the data for the BIF were analyzed using an independent samples _t_-test. No effect size was reported. Coverting from the reported test statistics, the effect size was _d_ = 0.90, 95% CI [0.17 , 1.63].
