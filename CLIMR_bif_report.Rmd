...
However, we still see that three is relatively little variation in random slopes.
...
Each of these likelihood ratio tests indicates that adding random slopes for each BIF item for the psychologicla distance conditions did not significantly improve the model, in each of these experiments from Grinfeld et al (2021).
