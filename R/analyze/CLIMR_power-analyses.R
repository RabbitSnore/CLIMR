...
smaller_n_temporal      <-     sum(abs(meta_temporal$beta[[1]]) < detectable_effects$d)
smaller_prop_temporal   <- 1 - smaller_n_temporal/nrow(detectable_effects)
  
smaller_n_spatial       <-     sum(abs(meta_spatial$beta[[1]]) < detectable_effects$d)
smaller_prop_spatial    <- 1 - smaller_n_spatial/nrow(detectable_effects)
  
smaller_n_social        <-     sum(abs(meta_social$beta[[1]]) < detectable_effects$d)
smaller_prop_social     <- 1 - smaller_n_social/nrow(detectable_effects)

smaller_n_likelihood    <-     sum(abs(meta_likelihood$beta[[1]]) < detectable_effects$d)
